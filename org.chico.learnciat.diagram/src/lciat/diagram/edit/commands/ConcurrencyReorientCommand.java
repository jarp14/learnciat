 ...
 * @generated
 */
public class ConcurrencyReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ConcurrencyReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Concurrency) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistConcurrency_4007(container, getLink(),
				getNewSource(), target);
	}
	...
	* @generated
	*/
	protected Concurrency getLink() {
		return (Concurrency) getElementToEdit();
	}
