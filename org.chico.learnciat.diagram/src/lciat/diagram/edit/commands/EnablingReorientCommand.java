...
public class EnablingReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistEnabling_4009(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		LCIANDiagram container = (LCIANDiagram) getLink().eContainer();
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistEnabling_4009(container, getLink(), source,
				getNewTarget());
	}
