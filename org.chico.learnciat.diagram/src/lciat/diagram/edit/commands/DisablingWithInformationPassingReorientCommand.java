...
public class DisablingWithInformationPassingReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDisablingWithInformationPassing_4012(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		LCIANDiagram container = (LCIANDiagram) getLink().eContainer();
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDisablingWithInformationPassing_4012(container, getLink(), source, getNewTarget());
	}
