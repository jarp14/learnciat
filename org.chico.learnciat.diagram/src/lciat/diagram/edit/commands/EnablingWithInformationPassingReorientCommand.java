...
public class EnablingWithInformationPassingReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEnablingWithInformationPassing_4011(container, getLink(), getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		LCIANDiagram container = (LCIANDiagram) getLink().eContainer();
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEnablingWithInformationPassing_4011(container, getLink(), source, getNewTarget());
	}
