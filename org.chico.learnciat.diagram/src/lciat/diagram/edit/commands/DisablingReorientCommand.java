...
public class DisablingReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistDisabling_4010(container, getLink(),
				getNewSource(), target);
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		LCIANDiagram container = (LCIANDiagram) getLink().eContainer();
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistDisabling_4010(container, getLink(), source,
				getNewTarget());
	}
