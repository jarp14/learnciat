 ...
 * @generated
 */
public class EnablingWOInformationReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EnablingWOInformationReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof EnablingWOInformation) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistEnablingWOInformation_4004(container,
	...
	* @generated
	*/
	protected EnablingWOInformation getLink() {
		return (EnablingWOInformation) getElementToEdit();
	}
