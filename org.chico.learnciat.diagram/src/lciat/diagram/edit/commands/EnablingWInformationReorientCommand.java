 ...
 * @generated
 */
public class EnablingWInformationReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public EnablingWInformationReorientCommand(ReorientRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof EnablingWInformation) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return LciatBaseItemSemanticEditPolicy.getLinkConstraints().canExistEnablingWInformation_4005(container,
	...
	* @generated
	*/
	protected EnablingWInformation getLink() {
		return (EnablingWInformation) getElementToEdit();
	}
