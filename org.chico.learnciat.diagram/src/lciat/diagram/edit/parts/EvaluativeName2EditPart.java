 ...
 * @generated
 */
public class EvaluativeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EvaluativeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Evaluative_3055, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EvaluativeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
