...
public class GroupNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Group_3002, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
