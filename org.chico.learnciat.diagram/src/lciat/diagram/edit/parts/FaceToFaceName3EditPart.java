 ...
 * @generated
 */
public class FaceToFaceName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.FaceToFaceName3EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public FaceToFaceName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.FaceToFace_3072, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.FaceToFaceName3EditPart.VISUAL_ID));
		}
		return parser;
	}
