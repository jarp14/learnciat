...
public class RolNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Rol_3001, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.RolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
