 ...
 * @generated
 */
public class InformationHandlingName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InformationHandlingName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.InformationHandling_3050, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InformationHandlingName2EditPart.VISUAL_ID));
		}
		return parser;
	}
