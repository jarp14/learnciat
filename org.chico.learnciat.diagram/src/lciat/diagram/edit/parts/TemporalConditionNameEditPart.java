...
public class TemporalConditionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.TemporalCondition_3091, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TemporalConditionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
