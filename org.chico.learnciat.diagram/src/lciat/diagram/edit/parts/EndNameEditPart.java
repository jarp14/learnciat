 ...
 * @generated
 */
public class EndNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EndNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.End_3090, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EndNameEditPart.VISUAL_ID));
		}
		return parser;
	}
