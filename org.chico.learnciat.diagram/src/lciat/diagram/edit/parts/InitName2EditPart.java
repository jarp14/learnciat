 ...
 * @generated
 */
public class InitName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InitName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Init_3102, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InitName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new InitLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InitLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InitLabelFigure() {
			this.setText("Init");
		}
