...
public class ApplicationTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ApplicationTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.ApplicationTask_3121, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ApplicationTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
