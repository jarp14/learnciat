...
public class OrderIndependenceOiLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OrderIndependenceOiLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.OrderIndependence_4014, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OrderIndependenceOiLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
