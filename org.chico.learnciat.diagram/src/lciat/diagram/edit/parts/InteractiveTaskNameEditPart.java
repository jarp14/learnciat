...
public class InteractiveTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InteractiveTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.InteractiveTask_3119, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InteractiveTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
