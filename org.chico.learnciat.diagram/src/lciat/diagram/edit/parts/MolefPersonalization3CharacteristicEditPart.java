 ...
 * @generated
 */
public class MolefPersonalization3CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefPersonalization3CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefPersonalization3_3023, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefPersonalization3CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
