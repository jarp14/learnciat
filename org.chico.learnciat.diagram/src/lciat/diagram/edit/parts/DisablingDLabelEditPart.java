...
public class DisablingDLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.DisablingDLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Disabling_4010, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.DisablingDLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
