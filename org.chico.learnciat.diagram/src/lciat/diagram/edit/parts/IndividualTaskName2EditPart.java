...
public class IndividualTaskName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.IndividualTask_3077, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.IndividualTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
