 ...
 * @generated
 */
public class ChatNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ChatNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Chat_3082, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ChatNameEditPart.VISUAL_ID));
		}
		return parser;
	}
