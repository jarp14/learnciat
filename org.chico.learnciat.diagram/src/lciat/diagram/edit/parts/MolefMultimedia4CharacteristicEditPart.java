 ...
 * @generated
 */
public class MolefMultimedia4CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefMultimedia4CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefMultimedia4_3110, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefMultimedia4CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
