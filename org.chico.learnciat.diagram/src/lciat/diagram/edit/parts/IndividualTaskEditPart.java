...
import lciat.diagram.edit.policies.IndividualTaskCanonicalEditPolicy;
import lciat.diagram.edit.policies.IndividualTaskItemSemanticEditPolicy;
...
public class IndividualTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IndividualTaskIndividualTaskSubtypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskSubtypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IndividualTaskIndividualTaskSubtypeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IndividualTaskIndividualTaskModalityCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskModalityCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((IndividualTaskIndividualTaskModalityCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof IndividualTaskIndividualTaskSubtypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskSubtypeCompartmentFigure();
			pane.remove(((IndividualTaskIndividualTaskSubtypeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof IndividualTaskIndividualTaskModalityCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getIndividualTaskModalityCompartmentFigure();
			pane.remove(((IndividualTaskIndividualTaskModalityCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GraphicalEditorEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof IndividualTaskIndividualTaskSubtypeCompartmentEditPart) {
			return getPrimaryShape().getIndividualTaskSubtypeCompartmentFigure();
		}
		if (editPart instanceof IndividualTaskIndividualTaskModalityCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LciatVisualIDRegistry.getType(IndividualTaskNameEditPart.VISUAL_ID));
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == LciatElementTypes.Assimilative_3033) {
				return getChildBySemanticHint(LciatVisualIDRegistry
						.getType(IndividualTaskIndividualTaskSubtypeCompartmentEditPart.VISUAL_ID));
			}
			...
			if (type == LciatElementTypes.FaceToFace_3041) {
				return getChildBySemanticHint(LciatVisualIDRegistry
						.getType(IndividualTaskIndividualTaskModalityCompartmentEditPart.VISUAL_ID));
			}
