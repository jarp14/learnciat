 ...
 * @generated
 */
public class ConcurrencyIcLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ConcurrencyIcLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ConcurrencyIcLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Concurrency_4007, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ConcurrencyIcLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ConcurrencyLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ConcurrencyLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ConcurrencyLabelFigure() {
			this.setText("Concurrency");
		}
