 ...
 * @generated
 */
public class ProductiveName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProductiveName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Productive_3068, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ProductiveName3EditPart.VISUAL_ID));
		}
		return parser;
	}
