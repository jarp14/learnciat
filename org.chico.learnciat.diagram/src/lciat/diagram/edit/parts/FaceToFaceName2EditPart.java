 ...
 * @generated
 */
public class FaceToFaceName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.FaceToFaceName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public FaceToFaceName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.FaceToFace_3057, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.FaceToFaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new FaceToFaceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class FaceToFaceLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public FaceToFaceLabelFigure() {
			this.setText("FaceToFace");
		}
