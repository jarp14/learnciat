...
public class RolName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Rol_3047, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.RolName3EditPart.VISUAL_ID));
		}
		return parser;
	}
