...
import lciat.diagram.edit.policies.GroupTaskGroupTaskSubtypeCompartmentCanonicalEditPolicy;
import lciat.diagram.edit.policies.GroupTaskGroupTaskSubtypeCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupTaskGroupTaskSubtypeCompartmentEditPart extends ListCompartmentEditPart {
	...
	* @generated
	*/
	public GroupTaskGroupTaskSubtypeCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.GroupTaskGroupTaskSubtypeCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new GroupTaskGroupTaskSubtypeCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(LciatVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new GroupTaskGroupTaskSubtypeCompartmentCanonicalEditPolicy());
	}
