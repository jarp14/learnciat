 ...
 * @generated
 */
public class SessionPanelName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SessionPanelName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.SessionPanel_3094, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SessionPanelName2EditPart.VISUAL_ID));
		}
		return parser;
	}
