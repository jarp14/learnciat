 ...
 * @generated
 */
public class AssimilativeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssimilativeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Assimilative_3033, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AssimilativeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
