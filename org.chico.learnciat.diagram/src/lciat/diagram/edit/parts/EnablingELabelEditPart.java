...
public class EnablingELabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EnablingELabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Enabling_4009, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EnablingELabelEditPart.VISUAL_ID));
		}
		return parser;
	}
