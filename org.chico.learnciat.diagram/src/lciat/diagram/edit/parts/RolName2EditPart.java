...
public class RolName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Rol_3027, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.RolName2EditPart.VISUAL_ID));
		}
		return parser;
	}
