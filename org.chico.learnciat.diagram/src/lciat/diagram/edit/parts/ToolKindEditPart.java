 ...
 * @generated
 */
public class ToolKindEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ToolKindEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Tool_3044, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ToolKindEditPart.VISUAL_ID));
		}
		return parser;
	}
