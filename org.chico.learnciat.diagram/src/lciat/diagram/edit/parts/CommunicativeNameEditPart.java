 ...
 * @generated
 */
public class CommunicativeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CommunicativeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Communicative_3036, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.CommunicativeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
