 ...
 * @generated
 */
public class MolefPersonalization1CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefPersonalization1CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefPersonalization1_3021, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefPersonalization1CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
