 ...
 * @generated
 */
public class MolefPersonalization5CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefPersonalization5CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefPersonalization5_3025, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefPersonalization5CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
