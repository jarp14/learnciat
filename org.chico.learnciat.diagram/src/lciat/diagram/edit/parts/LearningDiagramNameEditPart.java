 ...
 * @generated
 */
public class LearningDiagramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LearningDiagramNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.LearningDiagram_2002, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.LearningDiagramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
