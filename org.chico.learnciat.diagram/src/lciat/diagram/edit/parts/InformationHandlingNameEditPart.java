 ...
 * @generated
 */
public class InformationHandlingNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InformationHandlingNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.InformationHandling_3034, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InformationHandlingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
