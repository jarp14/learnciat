 ...
 * @generated
 */
public class PropertiesName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PropertiesName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Properties_3099, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.PropertiesName2EditPart.VISUAL_ID));
		}
		return parser;
	}
