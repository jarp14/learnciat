 ...
 * @generated
 */
public class GroupTaskName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GroupTaskName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.GroupTask_3078, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GroupTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
