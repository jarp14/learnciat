 ...
 * @generated
 */
public class WebViewerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public WebViewerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.WebViewer_3032, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.WebViewerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
