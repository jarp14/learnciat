 ...
 * @generated
 */
public class EvaluativeName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EvaluativeName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Evaluative_3070, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EvaluativeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
