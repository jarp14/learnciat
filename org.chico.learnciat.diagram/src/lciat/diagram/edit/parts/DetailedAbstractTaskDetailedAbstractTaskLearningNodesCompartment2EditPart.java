...
import lciat.diagram.edit.policies.DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2CanonicalEditPolicy;
import lciat.diagram.edit.policies.DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2EditPart
	...
	* @generated
	*/
	public DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(LciatVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartment2CanonicalEditPolicy());
	}
