...
import lciat.diagram.edit.policies.LciatTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EnablingWOInformationELabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EnablingWOInformationELabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EnablingWOInformationELabelEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new LciatTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.EnablingWOInformation_4004, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.EnablingWOInformationELabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, LciatEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnablingWOInformationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnablingWOInformationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnablingWOInformationLabelFigure() {
			this.setText("EnablingWOInformation");
		}
