 ...
 * @generated
 */
public class EnablingWInformationEwLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EnablingWInformationEwLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public EnablingWInformationEwLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.EnablingWInformation_4005, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.EnablingWInformationEwLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EnablingWInformationLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EnablingWInformationLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EnablingWInformationLabelFigure() {
			this.setText("EnablingWInformation");
		}
