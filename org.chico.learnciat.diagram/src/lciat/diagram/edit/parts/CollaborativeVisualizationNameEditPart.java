...
public class CollaborativeVisualizationNameEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry
				.getType(lciat.diagram.edit.parts.CollaborativeVisualizationNameEditPart.VISUAL_ID), new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.CollaborativeVisualization_3115,
					getParserElement(), LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.CollaborativeVisualizationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
