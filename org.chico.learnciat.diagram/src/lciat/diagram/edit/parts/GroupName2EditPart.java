...
public class GroupName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Group_3028, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GroupName2EditPart.VISUAL_ID));
		}
		return parser;
	}
