 ...
 * @generated
 */
public class ChatName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ChatName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Chat_3095, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ChatName2EditPart.VISUAL_ID));
		}
		return parser;
	}
