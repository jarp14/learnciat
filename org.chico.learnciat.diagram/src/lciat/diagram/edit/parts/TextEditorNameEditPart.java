 ...
 * @generated
 */
public class TextEditorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TextEditorNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.TextEditor_3030, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TextEditorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
