 ...
 * @generated
 */
public class ProblemsNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProblemsNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Problems_3088, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ProblemsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
