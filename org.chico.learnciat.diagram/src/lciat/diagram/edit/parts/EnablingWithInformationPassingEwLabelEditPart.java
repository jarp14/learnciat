...
public class EnablingWithInformationPassingEwLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry
						.getType(lciat.diagram.edit.parts.EnablingWithInformationPassingEwLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.EnablingWithInformationPassing_4011,
