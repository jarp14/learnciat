...
public class NotificationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Notification_3105, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.NotificationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
