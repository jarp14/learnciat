 ...
 * @generated
 */
public class ExperientialName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExperientialName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Experiential_3054, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ExperientialName2EditPart.VISUAL_ID));
		}
		return parser;
	}
