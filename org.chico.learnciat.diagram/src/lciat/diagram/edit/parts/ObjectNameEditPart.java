...
public class ObjectNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Object_3045, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ObjectNameEditPart.VISUAL_ID));
		}
		return parser;
	}
