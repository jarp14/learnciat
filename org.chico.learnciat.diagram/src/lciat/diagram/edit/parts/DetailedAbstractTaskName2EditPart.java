 ...
 * @generated
 */
public class DetailedAbstractTaskName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DetailedAbstractTaskName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.DetailedAbstractTask_3080, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.DetailedAbstractTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
