 ...
 * @generated
 */
public class OnlineNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OnlineNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public OnlineNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Online_3043, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OnlineNameEditPart.VISUAL_ID));
		}
		return parser;
	}
