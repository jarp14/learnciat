 ...
 * @generated
 */
public class SessionPanelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SessionPanelNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.SessionPanel_3081, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SessionPanelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
