 ...
 * @generated
 */
public class ComputerSupportedName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ComputerSupportedName3EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ComputerSupportedName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.ComputerSupported_3073, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ComputerSupportedName3EditPart.VISUAL_ID));
		}
		return parser;
	}
