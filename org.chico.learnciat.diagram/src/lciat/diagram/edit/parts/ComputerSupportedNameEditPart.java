 ...
 * @generated
 */
public class ComputerSupportedNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ComputerSupportedNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ComputerSupportedNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.ComputerSupported_3042, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ComputerSupportedNameEditPart.VISUAL_ID));
		}
		return parser;
	}
