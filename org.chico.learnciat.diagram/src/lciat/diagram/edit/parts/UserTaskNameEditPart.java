...
public class UserTaskNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.UserTaskNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.UserTask_3117, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.UserTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
