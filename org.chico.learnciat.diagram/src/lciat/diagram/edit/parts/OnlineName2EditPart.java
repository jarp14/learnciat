 ...
 * @generated
 */
public class OnlineName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OnlineName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public OnlineName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Online_3059, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OnlineName2EditPart.VISUAL_ID));
		}
		return parser;
	}
