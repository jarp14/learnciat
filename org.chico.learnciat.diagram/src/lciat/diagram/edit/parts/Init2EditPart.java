...
import lciat.diagram.edit.policies.Init2ItemSemanticEditPolicy;
import lciat.diagram.part.LciatVisualIDRegistry;

/**
 * @generated
 */
public class Init2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof InitName2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LciatVisualIDRegistry.getType(InitName2EditPart.VISUAL_ID));
	}
