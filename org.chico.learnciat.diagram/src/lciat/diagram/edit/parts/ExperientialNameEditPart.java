 ...
 * @generated
 */
public class ExperientialNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExperientialNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Experiential_3038, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ExperientialNameEditPart.VISUAL_ID));
		}
		return parser;
	}
