 ...
 * @generated
 */
public class SupportNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SupportNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Support_3040, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SupportNameEditPart.VISUAL_ID));
		}
		return parser;
	}
