...
import lciat.diagram.edit.policies.GroupTaskCanonicalEditPolicy;
import lciat.diagram.edit.policies.GroupTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GroupTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public GroupTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GroupTaskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new GroupTaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GroupTaskNameEditPart) {
			((GroupTaskNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureGroupTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskTaskRolesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupTaskGroupTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskTaskObjectsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupTaskGroupTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskSubtypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskSubtypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupTaskGroupTaskSubtypeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskModalityCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskModalityCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GroupTaskGroupTaskModalityCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GroupTaskGroupTaskTaskRolesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskTaskRolesCompartmentFigure();
			pane.remove(((GroupTaskGroupTaskTaskRolesCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskTaskObjectsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskTaskObjectsCompartmentFigure();
			pane.remove(((GroupTaskGroupTaskTaskObjectsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskSubtypeCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskSubtypeCompartmentFigure();
			pane.remove(((GroupTaskGroupTaskSubtypeCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GroupTaskGroupTaskModalityCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGroupTaskModalityCompartmentFigure();
			pane.remove(((GroupTaskGroupTaskModalityCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GraphicalEditorEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GroupTaskGroupTaskTaskRolesCompartmentEditPart) {
			return getPrimaryShape().getGroupTaskTaskRolesCompartmentFigure();
		}
		if (editPart instanceof GroupTaskGroupTaskTaskObjectsCompartmentEditPart) {
			return getPrimaryShape().getGroupTaskTaskObjectsCompartmentFigure();
		}
		if (editPart instanceof GroupTaskGroupTaskSubtypeCompartmentEditPart) {
			return getPrimaryShape().getGroupTaskSubtypeCompartmentFigure();
		}
		if (editPart instanceof GroupTaskGroupTaskModalityCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LciatVisualIDRegistry.getType(GroupTaskNameEditPart.VISUAL_ID));
	}
