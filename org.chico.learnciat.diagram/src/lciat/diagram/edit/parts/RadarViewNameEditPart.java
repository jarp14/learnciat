 ...
 * @generated
 */
public class RadarViewNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RadarViewNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.RadarView_3085, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.RadarViewNameEditPart.VISUAL_ID));
		}
		return parser;
	}
