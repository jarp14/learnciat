 ...
 * @generated
 */
public class ProductiveName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProductiveName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Productive_3053, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ProductiveName2EditPart.VISUAL_ID));
		}
		return parser;
	}
