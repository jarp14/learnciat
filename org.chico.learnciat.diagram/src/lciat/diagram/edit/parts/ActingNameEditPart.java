...
public class ActingNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ActingNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Acting_4002, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ActingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
