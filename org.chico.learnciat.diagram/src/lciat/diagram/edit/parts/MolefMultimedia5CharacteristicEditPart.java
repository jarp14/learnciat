 ...
 * @generated
 */
public class MolefMultimedia5CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefMultimedia5CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefMultimedia5_3111, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefMultimedia5CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
