 ...
 * @generated
 */
public class SupportName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SupportName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Support_3056, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SupportName2EditPart.VISUAL_ID));
		}
		return parser;
	}
