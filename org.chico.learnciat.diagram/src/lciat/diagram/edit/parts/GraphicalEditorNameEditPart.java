 ...
 * @generated
 */
public class GraphicalEditorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GraphicalEditorNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.GraphicalEditor_3029, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GraphicalEditorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
