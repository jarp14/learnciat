...
public class ExclusiveEditionNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ExclusiveEditionNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.ExclusiveEdition_3114, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ExclusiveEditionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
