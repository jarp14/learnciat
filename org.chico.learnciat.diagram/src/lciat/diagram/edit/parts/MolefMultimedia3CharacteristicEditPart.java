 ...
 * @generated
 */
public class MolefMultimedia3CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefMultimedia3CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefMultimedia3_3109, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefMultimedia3CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
