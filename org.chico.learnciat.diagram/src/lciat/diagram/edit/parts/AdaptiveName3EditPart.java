 ...
 * @generated
 */
public class AdaptiveName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdaptiveName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Adaptive_3066, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AdaptiveName3EditPart.VISUAL_ID));
		}
		return parser;
	}
