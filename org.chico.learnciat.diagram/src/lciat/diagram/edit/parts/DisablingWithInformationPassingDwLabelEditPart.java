...
public class DisablingWithInformationPassingDwLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry
						.getType(lciat.diagram.edit.parts.DisablingWithInformationPassingDwLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.DisablingWithInformationPassing_4012,
					getParserElement(), LciatVisualIDRegistry.getType(
							lciat.diagram.edit.parts.DisablingWithInformationPassingDwLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
