...
public class GroupName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Group_3048, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GroupName3EditPart.VISUAL_ID));
		}
		return parser;
	}
