 ...
 * @generated
 */
public class ChoiceDtLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ChoiceDtLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ChoiceDtLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Choice_4006, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ChoiceDtLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ChoiceLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ChoiceLabelFigure extends WrappingLabel {
