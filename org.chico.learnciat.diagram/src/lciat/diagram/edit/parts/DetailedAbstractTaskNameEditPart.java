 ...
 * @generated
 */
public class DetailedAbstractTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DetailedAbstractTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.DetailedAbstractTask_3076, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.DetailedAbstractTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
