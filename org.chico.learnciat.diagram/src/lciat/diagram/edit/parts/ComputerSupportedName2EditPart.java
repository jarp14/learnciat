 ...
 * @generated
 */
public class ComputerSupportedName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ComputerSupportedName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public ComputerSupportedName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.ComputerSupported_3058, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ComputerSupportedName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new ComputerSupportedLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ComputerSupportedLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ComputerSupportedLabelFigure() {
			this.setText("ComputerSupported");
		}
