 ...
 * @generated
 */
public class CodeEditorNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CodeEditorNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.CodeEditor_3031, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.CodeEditorNameEditPart.VISUAL_ID));
		}
		return parser;
	}
