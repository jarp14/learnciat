...
public class IndependentConcurrencyIcLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.IndependentConcurrencyIcLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.IndependentConcurrency_4013, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.IndependentConcurrencyIcLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
