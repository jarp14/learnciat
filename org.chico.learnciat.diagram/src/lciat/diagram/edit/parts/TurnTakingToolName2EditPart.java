 ...
 * @generated
 */
public class TurnTakingToolName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TurnTakingToolName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.TurnTakingTool_3096, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TurnTakingToolName2EditPart.VISUAL_ID));
		}
		return parser;
	}
