...
public class IndividualVisualizationNameEditPart extends LabelEditPart
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.IndividualVisualizationNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.IndividualVisualization_3116, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.IndividualVisualizationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
