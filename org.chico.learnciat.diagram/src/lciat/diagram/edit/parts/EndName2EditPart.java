 ...
 * @generated
 */
public class EndName2EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EndName2EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.End_3103, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EndName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new EndLabelFigure();
	}

	/**
	 * @generated
	 */
	public class EndLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public EndLabelFigure() {
			this.setText("End");
		}
