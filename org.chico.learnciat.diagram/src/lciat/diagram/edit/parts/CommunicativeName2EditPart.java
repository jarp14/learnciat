 ...
 * @generated
 */
public class CommunicativeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CommunicativeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Communicative_3052, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.CommunicativeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
