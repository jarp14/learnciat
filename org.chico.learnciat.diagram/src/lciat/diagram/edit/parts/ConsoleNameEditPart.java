 ...
 * @generated
 */
public class ConsoleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ConsoleNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Console_3087, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ConsoleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
