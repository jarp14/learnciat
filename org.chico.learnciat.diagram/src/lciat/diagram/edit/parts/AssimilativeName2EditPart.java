 ...
 * @generated
 */
public class AssimilativeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssimilativeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Assimilative_3049, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AssimilativeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
