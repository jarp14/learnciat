 ...
 * @generated
 */
public class GroupTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public GroupTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.GroupTask_3046, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GroupTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
