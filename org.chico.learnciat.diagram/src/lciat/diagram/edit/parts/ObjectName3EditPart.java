...
public class ObjectName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Object_3075, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ObjectName3EditPart.VISUAL_ID));
		}
		return parser;
	}
