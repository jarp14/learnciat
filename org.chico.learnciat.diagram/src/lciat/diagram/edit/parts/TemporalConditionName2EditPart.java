...
public class TemporalConditionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.TemporalCondition_3104, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TemporalConditionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
