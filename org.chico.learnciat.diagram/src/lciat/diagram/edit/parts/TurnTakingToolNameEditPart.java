 ...
 * @generated
 */
public class TurnTakingToolNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TurnTakingToolNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.TurnTakingTool_3083, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TurnTakingToolNameEditPart.VISUAL_ID));
		}
		return parser;
	}
