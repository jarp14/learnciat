 ...
 * @generated
 */
public class RadarViewName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RadarViewName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.RadarView_3098, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.RadarViewName2EditPart.VISUAL_ID));
		}
		return parser;
	}
