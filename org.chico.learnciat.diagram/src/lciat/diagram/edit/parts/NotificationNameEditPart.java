...
public class NotificationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Notification_3092, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.NotificationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
