...
import lciat.diagram.edit.policies.Group2ItemSemanticEditPolicy;
...
public class Group2EditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LciatVisualIDRegistry.getType(GroupName2EditPart.VISUAL_ID));
	}
