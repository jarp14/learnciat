 ...
 * @generated
 */
public class AssimilativeName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssimilativeName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Assimilative_3064, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AssimilativeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
