 ...
 * @generated
 */
public class AdaptiveName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdaptiveName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Adaptive_3051, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AdaptiveName2EditPart.VISUAL_ID));
		}
		return parser;
	}
