 ...
 * @generated
 */
public class MolefMultimedia6CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefMultimedia6CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefMultimedia6_3112, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefMultimedia6CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
