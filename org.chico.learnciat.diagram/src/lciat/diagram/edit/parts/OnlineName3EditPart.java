 ...
 * @generated
 */
public class OnlineName3EditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OnlineName3EditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public OnlineName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Online_3074, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.OnlineName3EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new OnlineLabelFigure();
	}

	/**
	 * @generated
	 */
	public class OnlineLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public OnlineLabelFigure() {
			this.setText("Online");
		}
