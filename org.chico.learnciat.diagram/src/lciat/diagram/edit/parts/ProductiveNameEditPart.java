 ...
 * @generated
 */
public class ProductiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProductiveNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Productive_3037, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ProductiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
