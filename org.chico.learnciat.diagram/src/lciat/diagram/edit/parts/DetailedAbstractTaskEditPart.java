...
import lciat.diagram.edit.policies.DetailedAbstractTaskCanonicalEditPolicy;
import lciat.diagram.edit.policies.DetailedAbstractTaskItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DetailedAbstractTaskEditPart extends AbstractBorderedShapeEditPart {
	...
	* @generated
	*/
	public DetailedAbstractTaskEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DetailedAbstractTaskItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new DetailedAbstractTaskCanonicalEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DetailedAbstractTaskNameEditPart) {
			((DetailedAbstractTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureDetailedAbstractTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDetailedAbstractTaskLearningNodesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDetailedAbstractTaskLearningNodesCompartmentFigure();
			pane.remove(((DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof GraphicalEditorEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LciatVisualIDRegistry.getType(DetailedAbstractTaskNameEditPart.VISUAL_ID));
	}
