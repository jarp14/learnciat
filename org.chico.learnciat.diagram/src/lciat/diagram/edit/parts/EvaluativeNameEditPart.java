 ...
 * @generated
 */
public class EvaluativeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public EvaluativeNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Evaluative_3039, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.EvaluativeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
