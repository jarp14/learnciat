...
public class ConditionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Condition_3106, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ConditionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
