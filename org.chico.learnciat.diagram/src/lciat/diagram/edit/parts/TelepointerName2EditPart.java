 ...
 * @generated
 */
public class TelepointerName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TelepointerName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Telepointer_3097, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TelepointerName2EditPart.VISUAL_ID));
		}
		return parser;
	}
