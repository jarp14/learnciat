...
public class SuspendResumeSrLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SuspendResumeSrLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.SuspendResume_4015, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SuspendResumeSrLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
