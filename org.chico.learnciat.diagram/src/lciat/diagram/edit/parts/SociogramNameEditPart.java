...
public class SociogramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Sociogram_2001, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.SociogramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
