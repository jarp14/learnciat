...
public class CTTDiagramNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.CTTDiagram_2003, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.CTTDiagramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
