 ...
 * @generated
 */
public class TelepointerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public TelepointerNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Telepointer_3084, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.TelepointerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
