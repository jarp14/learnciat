...
public class GroupName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Group_3063, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.GroupName4EditPart.VISUAL_ID));
		}
		return parser;
	}
