...
public class AbstractTaskName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.AbstractTask_3079, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AbstractTaskName2EditPart.VISUAL_ID));
		}
		return parser;
	}
