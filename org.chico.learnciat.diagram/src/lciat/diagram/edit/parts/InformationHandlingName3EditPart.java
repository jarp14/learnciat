 ...
 * @generated
 */
public class InformationHandlingName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InformationHandlingName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.InformationHandling_3065, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InformationHandlingName3EditPart.VISUAL_ID));
		}
		return parser;
	}
