 ...
 * @generated
 */
public class PropertiesNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PropertiesNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Properties_3086, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.PropertiesNameEditPart.VISUAL_ID));
		}
		return parser;
	}
