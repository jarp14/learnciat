...
import lciat.diagram.edit.policies.AbstractTask2CanonicalEditPolicy;
import lciat.diagram.edit.policies.AbstractTask2ItemSemanticEditPolicy;
...
public class AbstractTask2EditPart extends AbstractBorderedShapeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AbstractTaskAbstractTaskTaskRolesCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskTaskRolesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AbstractTaskAbstractTaskTaskRolesCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AbstractTaskAbstractTaskTaskObjectsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskTaskObjectsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AbstractTaskAbstractTaskTaskObjectsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AbstractTaskAbstractTaskSubtypeCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskSubtypeCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AbstractTaskAbstractTaskSubtypeCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AbstractTaskAbstractTaskModalityCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskModalityCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AbstractTaskAbstractTaskModalityCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AbstractTaskAbstractTaskTaskRolesCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskTaskRolesCompartmentFigure();
			pane.remove(((AbstractTaskAbstractTaskTaskRolesCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AbstractTaskAbstractTaskTaskObjectsCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskTaskObjectsCompartmentFigure();
			pane.remove(((AbstractTaskAbstractTaskTaskObjectsCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AbstractTaskAbstractTaskSubtypeCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskSubtypeCompartmentFigure();
			pane.remove(((AbstractTaskAbstractTaskSubtypeCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof AbstractTaskAbstractTaskModalityCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getAbstractTaskModalityCompartmentFigure();
			pane.remove(((AbstractTaskAbstractTaskModalityCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof GraphicalEditorEditPart) {
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AbstractTaskAbstractTaskTaskRolesCompartment2EditPart) {
			return getPrimaryShape().getAbstractTaskTaskRolesCompartmentFigure();
		}
		if (editPart instanceof AbstractTaskAbstractTaskTaskObjectsCompartment2EditPart) {
			return getPrimaryShape().getAbstractTaskTaskObjectsCompartmentFigure();
		}
		if (editPart instanceof AbstractTaskAbstractTaskSubtypeCompartment2EditPart) {
			return getPrimaryShape().getAbstractTaskSubtypeCompartmentFigure();
		}
		if (editPart instanceof AbstractTaskAbstractTaskModalityCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LciatVisualIDRegistry.getType(AbstractTaskName2EditPart.VISUAL_ID));
	}
		...
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == LciatElementTypes.Object_3075) {
				return getChildBySemanticHint(LciatVisualIDRegistry
						.getType(AbstractTaskAbstractTaskTaskObjectsCompartment2EditPart.VISUAL_ID));
			}
