...
public class RolName4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Rol_3062, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.RolName4EditPart.VISUAL_ID));
		}
		return parser;
	}
