 ...
 * @generated
 */
public class AdaptiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AdaptiveNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Adaptive_3035, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.AdaptiveNameEditPart.VISUAL_ID));
		}
		return parser;
	}
