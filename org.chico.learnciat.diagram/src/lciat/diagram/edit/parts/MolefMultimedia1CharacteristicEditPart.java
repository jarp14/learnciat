 ...
 * @generated
 */
public class MolefMultimedia1CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefMultimedia1CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefMultimedia1_3107, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefMultimedia1CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
