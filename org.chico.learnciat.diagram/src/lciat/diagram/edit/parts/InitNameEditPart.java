 ...
 * @generated
 */
public class InitNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InitNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Init_3089, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InitNameEditPart.VISUAL_ID));
		}
		return parser;
	}
