 ...
 * @generated
 */
public class FaceToFaceNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.FaceToFaceNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	* @generated
	*/
	public FaceToFaceNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.FaceToFace_3041, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.FaceToFaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
