 ...
 * @generated
 */
public class MolefPersonalization2CharacteristicEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MolefPersonalization2CharacteristicEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.MolefPersonalization2_3022, getParserElement(),
					LciatVisualIDRegistry
							.getType(lciat.diagram.edit.parts.MolefPersonalization2CharacteristicEditPart.VISUAL_ID));
		}
		return parser;
	}
