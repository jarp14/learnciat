 ...
 * @generated
 */
public class ExperientialName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExperientialName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Experiential_3069, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ExperientialName3EditPart.VISUAL_ID));
		}
		return parser;
	}
