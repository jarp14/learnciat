...
public class InheritanceConditionEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InheritanceConditionEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Inheritance_4001, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.InheritanceConditionEditPart.VISUAL_ID));
		}
		return parser;
	}
