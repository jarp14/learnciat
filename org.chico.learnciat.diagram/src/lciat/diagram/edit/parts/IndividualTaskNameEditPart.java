...
public class IndividualTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.IndividualTask_3026, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.IndividualTaskNameEditPart.VISUAL_ID));
		}
		return parser;
	}
