...
public class ObjectName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.Object_3060, getParserElement(),
					LciatVisualIDRegistry.getType(lciat.diagram.edit.parts.ObjectName2EditPart.VISUAL_ID));
		}
		return parser;
	}
