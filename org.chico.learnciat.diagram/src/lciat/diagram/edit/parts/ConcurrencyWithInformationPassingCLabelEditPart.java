...
public class ConcurrencyWithInformationPassingCLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				LciatVisualIDRegistry
						.getType(lciat.diagram.edit.parts.ConcurrencyWithInformationPassingCLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LciatParserProvider.getParser(LciatElementTypes.ConcurrencyWithInformationPassing_4016,
					getParserElement(), LciatVisualIDRegistry.getType(
							lciat.diagram.edit.parts.ConcurrencyWithInformationPassingCLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
