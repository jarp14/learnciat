...
public class IndividualTaskIndividualTaskTaskObjectsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getIndividualTask_TaskObjects();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskObjectsCompartment_7019SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ObjectEditPart.VISUAL_ID == LciatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskObjectsCompartment_7019SemanticChildren(
