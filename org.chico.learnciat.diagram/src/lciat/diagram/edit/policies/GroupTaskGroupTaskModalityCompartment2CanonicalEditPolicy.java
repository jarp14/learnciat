 ...
 * @generated
 */
public class GroupTaskGroupTaskModalityCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getGroupTask_Modality();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskModalityCompartment_7025SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == FaceToFace2EditPart.VISUAL_ID || visualID == ComputerSupported2EditPart.VISUAL_ID
				|| visualID == Online2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskModalityCompartment_7025SemanticChildren((View) getHost().getModel());
