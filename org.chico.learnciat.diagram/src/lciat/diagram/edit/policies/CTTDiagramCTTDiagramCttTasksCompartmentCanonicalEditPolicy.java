...
public class CTTDiagramCTTDiagramCttTasksCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getCTTDiagram_CttTasks();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getCTTDiagramCTTDiagramCttTasksCompartment_7031SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getCTTDiagramCTTDiagramCttTasksCompartment_7031SemanticChildren((View) getHost().getModel());
