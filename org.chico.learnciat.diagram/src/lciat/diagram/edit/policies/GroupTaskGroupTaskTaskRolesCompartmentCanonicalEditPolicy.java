 ...
 * @generated
 */
public class GroupTaskGroupTaskTaskRolesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskTaskRolesCompartment_7009SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskTaskRolesCompartment_7009SemanticChildren((View) getHost().getModel());
