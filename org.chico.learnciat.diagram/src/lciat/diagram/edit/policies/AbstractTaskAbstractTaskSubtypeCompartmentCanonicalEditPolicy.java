 ...
 * @generated
 */
public class AbstractTaskAbstractTaskSubtypeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskSubtypeCompartment_7015SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskSubtypeCompartment_7015SemanticChildren((View) getHost().getModel());
