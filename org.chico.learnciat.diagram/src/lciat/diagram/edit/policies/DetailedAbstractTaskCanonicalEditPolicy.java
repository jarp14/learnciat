 ...
 * @generated
 */
public class DetailedAbstractTaskCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getDetailedAbstractTask_3076SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getDetailedAbstractTask_3076SemanticChildren((View) getHost().getModel());
