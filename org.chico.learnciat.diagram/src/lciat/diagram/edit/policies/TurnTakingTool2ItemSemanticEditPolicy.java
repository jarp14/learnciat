...
import lciat.diagram.edit.commands.TraceabilityCreateCommand;
import lciat.diagram.edit.commands.TraceabilityReorientCommand;
 ...
 * @generated
 */
public class TurnTakingTool2ItemSemanticEditPolicy extends LciatBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public TurnTakingTool2ItemSemanticEditPolicy() {
		super(LciatElementTypes.TurnTakingTool_3096);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (LciatElementTypes.Traceability_4019 == req.getElementType()) {
			return getGEFWrapper(new TraceabilityCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientRelationshipCommand(ReorientRelationshipRequest req) {
		...
		case TraceabilityEditPart.VISUAL_ID:
			return getGEFWrapper(new TraceabilityReorientCommand(req));
		}
