 ...
 * @generated
 */
public class GroupTaskGroupTaskSubtypeCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getGroupTask_Subtype();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskSubtypeCompartment_7024SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskSubtypeCompartment_7024SemanticChildren((View) getHost().getModel());
