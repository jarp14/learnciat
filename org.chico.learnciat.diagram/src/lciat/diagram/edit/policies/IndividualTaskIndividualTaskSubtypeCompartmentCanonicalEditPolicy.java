 ...
 * @generated
 */
public class IndividualTaskIndividualTaskSubtypeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskSubtypeCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskSubtypeCompartment_7007SemanticChildren((View) getHost().getModel());
