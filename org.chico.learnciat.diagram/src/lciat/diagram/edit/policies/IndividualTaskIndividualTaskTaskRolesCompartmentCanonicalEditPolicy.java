...
public class IndividualTaskIndividualTaskTaskRolesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getIndividualTask_TaskRoles();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskRolesCompartment_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == Rol2EditPart.VISUAL_ID || visualID == Group2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskTaskRolesCompartment_7005SemanticChildren((View) getHost().getModel());
