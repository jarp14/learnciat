 ...
 * @generated
 */
public class AbstractTaskAbstractTaskSubtypeCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getAbstractTask_Subtype();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskSubtypeCompartment_7028SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskSubtypeCompartment_7028SemanticChildren((View) getHost().getModel());
