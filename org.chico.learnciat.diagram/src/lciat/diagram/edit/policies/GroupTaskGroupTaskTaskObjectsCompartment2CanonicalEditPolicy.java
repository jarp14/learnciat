 ...
 * @generated
 */
public class GroupTaskGroupTaskTaskObjectsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getGroupTask_TaskObjects();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskTaskObjectsCompartment_7023SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Object2EditPart.VISUAL_ID == LciatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskTaskObjectsCompartment_7023SemanticChildren((View) getHost().getModel());
