 ...
 * @generated
 */
public class AbstractTaskAbstractTaskTaskObjectsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getAbstractTask_TaskObjects();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskTaskObjectsCompartment_7027SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Object3EditPart.VISUAL_ID == LciatVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskTaskObjectsCompartment_7027SemanticChildren((View) getHost().getModel());
