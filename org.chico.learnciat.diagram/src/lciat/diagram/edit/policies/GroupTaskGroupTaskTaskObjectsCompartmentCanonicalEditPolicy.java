 ...
 * @generated
 */
public class GroupTaskGroupTaskTaskObjectsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskTaskObjectsCompartment_7010SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskTaskObjectsCompartment_7010SemanticChildren((View) getHost().getModel());
