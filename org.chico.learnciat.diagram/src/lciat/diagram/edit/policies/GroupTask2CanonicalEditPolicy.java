 ...
 * @generated
 */
public class GroupTask2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getLearningActivity_Tools();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater.getGroupTask_3078SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTask_3078SemanticChildren((View) getHost().getModel());
