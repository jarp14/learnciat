 ...
 * @generated
 */
public class IndividualTaskIndividualTaskModalityCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getIndividualTask_Modality();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskModalityCompartment_7021SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == FaceToFaceEditPart.VISUAL_ID || visualID == ComputerSupportedEditPart.VISUAL_ID
				|| visualID == OnlineEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskModalityCompartment_7021SemanticChildren((View) getHost().getModel());
