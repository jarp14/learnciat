 ...
 * @generated
 */
public class GroupTaskGroupTaskSubtypeCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskSubtypeCompartment_7011SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getGroupTaskGroupTaskSubtypeCompartment_7011SemanticChildren((View) getHost().getModel());
