...
import lciat.diagram.edit.parts.DetailedAbstractTaskDetailedAbstractTaskLearningNodesCompartmentEditPart;
 ...
 * @generated
 */
public class DetailedAbstractTaskItemSemanticEditPolicy extends LciatBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public DetailedAbstractTaskItemSemanticEditPolicy() {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case IndividualTask2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it.hasNext();) {
							...
							if (LciatVisualIDRegistry
									.getVisualID(incomingLink) == EnablingWOInformationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
							...
							if (LciatVisualIDRegistry
									.getVisualID(incomingLink) == EnablingWInformationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
								continue;
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (LciatVisualIDRegistry
									.getVisualID(outgoingLink) == EnablingWOInformationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
							...
							if (LciatVisualIDRegistry
									.getVisualID(outgoingLink) == EnablingWInformationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
					...
					case SessionPanelEditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (LciatVisualIDRegistry.getVisualID(outgoingLink) == TraceabilityEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
								continue;
