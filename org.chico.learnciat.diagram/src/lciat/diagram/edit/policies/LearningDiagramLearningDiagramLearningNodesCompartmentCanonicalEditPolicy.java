 ...
 * @generated
 */
public class LearningDiagramLearningDiagramLearningNodesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getLearningDiagram_LearningNodes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getLearningDiagramLearningDiagramLearningNodesCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getLearningDiagramLearningDiagramLearningNodesCompartment_7003SemanticChildren(
