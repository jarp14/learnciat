 ...
 * @generated
 */
public class IndividualTaskIndividualTaskSubtypeCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getIndividualTask_Subtype();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskSubtypeCompartment_7020SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskSubtypeCompartment_7020SemanticChildren((View) getHost().getModel());
