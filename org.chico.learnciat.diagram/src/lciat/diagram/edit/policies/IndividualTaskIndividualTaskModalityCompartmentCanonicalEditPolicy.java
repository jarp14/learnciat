 ...
 * @generated
 */
public class IndividualTaskIndividualTaskModalityCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskModalityCompartment_7008SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getIndividualTaskIndividualTaskModalityCompartment_7008SemanticChildren((View) getHost().getModel());
