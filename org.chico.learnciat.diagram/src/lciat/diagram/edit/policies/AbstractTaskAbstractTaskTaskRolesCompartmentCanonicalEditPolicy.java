 ...
 * @generated
 */
public class AbstractTaskAbstractTaskTaskRolesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskTaskRolesCompartment_7013SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskTaskRolesCompartment_7013SemanticChildren((View) getHost().getModel());
