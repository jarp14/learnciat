...
import lciat.diagram.edit.commands.ActingCreateCommand;
import lciat.diagram.edit.commands.ActingReorientCommand;
import lciat.diagram.edit.commands.AssociationCreateCommand;
import lciat.diagram.edit.commands.AssociationReorientCommand;
import lciat.diagram.edit.commands.InheritanceCreateCommand;
import lciat.diagram.edit.commands.InheritanceReorientCommand;
 ...
 * @generated
 */
public class Group4ItemSemanticEditPolicy extends LciatBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Group4ItemSemanticEditPolicy() {
		super(LciatElementTypes.Group_3063);
	}
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (LciatElementTypes.Inheritance_4001 == req.getElementType()) {
			return getGEFWrapper(new InheritanceCreateCommand(req, req.getSource(), req.getTarget()));
		}
		if (LciatElementTypes.Acting_4002 == req.getElementType()) {
			return getGEFWrapper(new ActingCreateCommand(req, req.getSource(), req.getTarget()));
		}
		if (LciatElementTypes.Association_4003 == req.getElementType()) {
