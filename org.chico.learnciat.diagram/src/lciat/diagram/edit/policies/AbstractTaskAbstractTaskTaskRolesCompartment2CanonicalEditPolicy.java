 ...
 * @generated
 */
public class AbstractTaskAbstractTaskTaskRolesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return LciatPackage.eINSTANCE.getAbstractTask_TaskRoles();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskTaskRolesCompartment_7026SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == Rol4EditPart.VISUAL_ID || visualID == Group4EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getAbstractTaskAbstractTaskTaskRolesCompartment_7026SemanticChildren((View) getHost().getModel());
