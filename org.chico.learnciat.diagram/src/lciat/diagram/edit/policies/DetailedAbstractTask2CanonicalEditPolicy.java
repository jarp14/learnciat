 ...
 * @generated
 */
public class DetailedAbstractTask2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getDetailedAbstractTask_3080SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<LciatNodeDescriptor> childDescriptors = LciatDiagramUpdater
				.getDetailedAbstractTask_3080SemanticChildren((View) getHost().getModel());
