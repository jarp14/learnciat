...
/**
 * This is the item provider adapter for a {@link lciat.Properties} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertiesItemProvider extends AwarenessItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LciatPackage.Literals.PROPERTIES__NAME,
				 false,
				 false,
				 false,
	...
	protected void addPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Properties_position_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Properties_position_feature", "_UI_Properties_type"),
				 LciatPackage.Literals.PROPERTIES__POSITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
