...
/**
 * This is the item provider adapter for a {@link lciat.Rol} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Rol_itsGroup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Rol_itsGroup_feature", "_UI_Rol_type"),
				 LciatPackage.Literals.ROL__ITS_GROUP,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LciatPackage.Literals.ROL__SUPERTYPE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LciatPackage.Literals.ROL__SUBTYPE,
				 true,
				 false,
				 true,
				 null,
